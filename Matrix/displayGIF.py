...
"""This will display an animated GIF.  The GIF needs to be in the same folder as this file, or you must modify the path in order for it to work.
code was adapted from Simon Ince's Gif-viewer found here https://gist.github.com/Simon-Ince/910c440eb34bb722afa90853ecfb1d85 """
#!/usr/bin/env python
