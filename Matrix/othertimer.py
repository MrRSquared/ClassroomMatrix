#!/usr/bin/python
'''This code is adapted from liquidHex' that can be found here... 
https://github.com/liquidthex/ThexBerryClock/blob/master/ThexBerryClock.py'''
...
def startUp():
  ...
  TBC['font'] = ImageFont.load(basePath + "/pilfonts/timR08.pil") # TODO
  TBC['blockheight'] = 0
